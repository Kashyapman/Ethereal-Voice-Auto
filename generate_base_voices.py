...
# We commented out the 4 you already generated to save time and quota!
VOICES_TO_GENERATE = {
...
def generate_reference_audio(archetype_name, gemini_voice_name):
    ...
    # We give it 3 attempts per voice to account for the rate limit
...
if __name__ == "__main__":
    print("🚀 Resuming Ethereal Voice Cloning Generation...\n")
    for archetype, gemini_voice in VOICES_TO_GENERATE.items():
        generate_reference_audio(archetype, gemini_voice)
        # Adding a small 5-second buffer between successful requests just to be safe
        time.sleep(5) 
